...
if($tipo == "image/jpg" || $tipo == "image/jpeg" || $tipo == "image/png" || $tipo == "image/gif" ){
    ...
    header("Refresh: 5; index.php");//Redirecciona hasta que pasen 5 segundos a la pagina index.php
    echo "<h1> El archivo se cargo correctamente </h1>";

}else{
    echo "<h1>Suba una imagen con un formato correcto porfis</h1>";
    header("Refresh: 5; index.php");//Redirecciona hasta que pasen 5 segundo a la pagina index.php
}
