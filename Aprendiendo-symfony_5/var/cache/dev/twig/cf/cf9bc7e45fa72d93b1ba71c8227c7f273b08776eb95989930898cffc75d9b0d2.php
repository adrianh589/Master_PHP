...
class __TwigTemplate_73899a5b4a819b0b96b84b582d103f4d250eb85b5d8519697d8ae296b93f9154 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"example-wrapper\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["animales"]) || array_key_exists("animales", $context) ? $context["animales"] : (function () { throw new RuntimeError('Variable "animales" does not exist.', 25, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["animal"]) {
            // line 26
            echo "            ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["animal"], "color", [], "any", false, false, false, 26), "html", null, true);
            echo "<br>
        ";
        }
...
";
    ...
    {
        return array (  128 => 28,  119 => 26,  115 => 25,  110 => 23,  105 => 21,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "animal/index.html.twig", "/opt/lampp/htdocs/web/Master_PHP/aprendiendo-symfony/templates/animal/index.html.twig");
    }
}
