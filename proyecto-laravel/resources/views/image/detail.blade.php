                ...
                <div class="card pub_image pub_image_detail">
                    ...
                    <div class="card-body">
                        ...
                        <div class="description">
                            ...
                            <!-- Esto se creo mediante el Provider que se creo manualmente -->
                            <br>
                            {{$image->description}}
                        </div>
                        ...
                        <div class="likes">
                            ...
                            @if($user_like)
                                <img src="{{asset('img/heart-orange.png')}}" data-id="{{$image->id}}"
                                     class="btn-dislike">
                            @else
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Si eliminas esta imagen, nunca podras recuperarla ¿Estas seguro de eliminar esta imagen?
                                            </div>
