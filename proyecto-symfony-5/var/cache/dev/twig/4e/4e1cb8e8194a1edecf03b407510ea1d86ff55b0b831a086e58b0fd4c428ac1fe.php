...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/config.html.twig", "/opt/lampp/htdocs/web/Master_PHP/proyecto-symfony/vendor/symfony/web-profiler-bundle/Resources/views/Collector/config.html.twig");
    }
}
