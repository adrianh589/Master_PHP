...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/validator.html.twig", "/opt/lampp/htdocs/web/Master_PHP/proyecto-symfony/vendor/symfony/web-profiler-bundle/Resources/views/Collector/validator.html.twig");
    }
}
