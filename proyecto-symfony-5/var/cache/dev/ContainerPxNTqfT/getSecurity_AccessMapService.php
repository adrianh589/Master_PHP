...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/detail'), [0 => 'ROLE_USER'], NULL);
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/mis-tarea'), [0 => 'ROLE_USER'], NULL);
